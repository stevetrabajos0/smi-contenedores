            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="relative bg-slate-50 border-2 border-slate-200 rounded-2xl p-8 hover:border-[#D32F2F] transition-all duration-200 group">
                ...
                <div className="w-16 h-16 bg-[#D32F2F] bg-opacity-10 rounded-xl flex items-center justify-center mb-6 group-hover:bg-[#D32F2F] transition-colors">
                  <svg className="w-8 h-8 stroke-[#D32F2F] group-hover:stroke-white transition-colors" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className="w-full bg-[#D32F2F] hover:bg-[#B71C1C] text-white py-3 rounded-lg font-semibold transition-colors duration-200"
                >
                  Cotizar Renta
                </button>
              </div>
              ...
              <div className="bg-slate-50 border-2 border-slate-200 rounded-2xl p-8 hover:border-[#D32F2F] transition-all duration-200 group">
                ...
                <button
                  ...
                  className="w-full bg-white hover:bg-slate-50 text-slate-900 border-2 border-slate-300 hover:border-[#D32F2F] py-3 rounded-lg font-semibold transition-all duration-200"
                >
                  Cotizar Compra
                </button>
              </div>
